  ...
  const messages = [
    {
      ...
      Use the Unsplash API (https://unsplash.com/developers). the query is just some tags that describes the image ## DO NOT RESPOND TO INFO BLOCK ##`,
    },
    {
      role: "system",
    ...
    },
    {
      ...
      content: `1. [title] : Think of the diary title after understanding the [events] separated by """ at the bottom.
        ...
        8. [image] : Create an image by making the contents so far into one keyword. this is image url
